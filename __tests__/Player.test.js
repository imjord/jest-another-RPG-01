...
test('gets players health value', () => {
    ...
    expect(player.getHealth()).toEqual(expect.stringContaining(player.health.toString())) // show players health 
})
...
test('subtracts from players health', () => {
    const player = new Player('dave');  // important to create a new object with every test to test in isolation 
    ...
    player.reduceHealth(99999); // make sure health doesnt go negative 
